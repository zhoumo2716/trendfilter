...
None empty `left_boundary_m` and `right_boundary_m` enables boundary correction using Newton polynomials and divided differences.
...
```{r boundary-constraint-plots, message=FALSE, warning=FALSE, dev='png'}
# ---- Plots ----
