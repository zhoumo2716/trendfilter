...
admm_single_lambda <- function(n, y, weights, k, theta_init, penalty_mat, dk_mat, lam, max_iter, rho, tol = 1e-5, tridiag = FALSE) {
    .Call(`_trendfilter_admm_single_lambda`, n, y, weights, k, theta_init, penalty_mat, dk_mat, lam, max_iter, rho, tol, tridiag)
}
